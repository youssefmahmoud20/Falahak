...
const FooterFour = () => {
  return (
    <footer className='footer-three fc-footer-three'>
      <div className='container'>
        <div className='row gutter-30'>
          <div className='col-12 col-lg-3'>
            ...
            >
              <Link href='/'>
                <img src='assets/images/logo-two-light.png' alt='Image_inner' />
              </Link>
            </div>
          </div>
          ...
          <div className='col-12 col-md-6 col-xl-3'>
            ...
            >
              ...
              <div className='footer-three__widget-alt'>
                <div className='footer-two__widget-intro'>
                  <h6 className='title-animation_inner'>Opening Hours</h6>
                </div>
                <div className='footer-three__widget-single'>
                  <p>9.30am - 6.30pm</p>
                  ...
                  <div className='footer__newsletter-check'>
                    <div className='form-group'>
                      ...
                      <label htmlFor='acceptPolicy'>
                        I agree all your <a href='terms-conditions'>Terms</a>{" "}
                        &amp;
